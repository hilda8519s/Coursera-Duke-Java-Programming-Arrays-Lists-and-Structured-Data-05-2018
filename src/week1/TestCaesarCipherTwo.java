...
public class TestCaesarCipherTwo {
    ...
    // countLetters
    private static void countLetters(String encrypted, int[] counts){
    ...
    public static void simpleTests() {
       ...
       fr = new FileResource("/Users/bocanhu/eclipse-workspace/CourseraOOD2/src/week1/data/mysteryTwoKeysQuiz.txt");
        input = fr.asString();
